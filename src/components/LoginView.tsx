// LoginView.tsx - Login component with Google Sign-In
    ...
    <div className="w-full max-w-md mx-auto p-8">
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full py-4 px-4 rounded-lg bg-white hover:bg-stone-100 text-stone-800 font-bold text-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-6"
        >
        ...
        <div className="relative mb-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-stone-500/30"></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-[#643d2c] text-stone-400">or continue with email</span>
          </div>
        </div>
